...
- Using venv for EDA part:
  ...
  - pip install -r requirements\**requirements-eda**.txt
...
- Using venv for ML part (XGB/TFT):
  ...
  - python.exe -m pip install --upgrade pip
  - - pip install -r requirements\**requirements-xgb-tft**.txt
...
- Using venv for TFT interpretation part:
  ...
  - python.exe -m pip install --upgrade pip
  - - pip install -r requirements\**requirements-tft-interpretation**.txt
